package App::Sam::Syntax::Properties;
...
sub __classifications {
    return ( SYNTAX_COMMENT, SYNTAX_DATA );
}
...
App::Sam::Syntax::Properties - Classify Java property file syntax
...
Any line whose first non-blank character is C<'#'> or C<'!'>, or
...
This classifier can be used for Java .properties files.
