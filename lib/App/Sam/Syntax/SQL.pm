...
App::Sam::Syntax::SQL - Classify SQL script syntax
...
Any line whose first non-blank characters are C<'--'>, plus C-style
block comments.

=back

This classifier can be used for SQL scripts.
