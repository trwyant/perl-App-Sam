package App::Sam::Syntax::Fortran;
...
App::Sam::Syntax::Fortran - Classify Fortran file syntax
...
Any line whose first character is C<'C'>, C<'c'>, or C<'*'>, or whose
first non-whitespace character is C<'!'>.

=back

This classifier can be used for Fortran source files.
