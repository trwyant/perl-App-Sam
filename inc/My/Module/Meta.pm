...
##  }
	...
	'Getopt::Long'	=> 2.39,	# for getoptionsfromarray, auto_version
...
My::Module::Meta - Information needed to build App::Sam
...
This module centralizes information needed to build C<App::Sam>. It
is private to the C<App::Sam> package, and may be changed or
...
modules required to build the C<App::Sam> package, suitable for
...
the modules required to run the C<App::Sam>
...
Copyright (C) 2023-2026 by Thomas R. Wyant, III
